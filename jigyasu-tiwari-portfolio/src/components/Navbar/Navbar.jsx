...
//         isScrolled
//           ? "bg-[#050414] bg-opacity-50 backdrop-50 backdrop-blur-md shadow-md"
//           : "bg-transparent"
//       }`}
//     >
...
//           <span className="text-[#8245ec]">Jigyasu</span>
//           <span className="text-[#8245ec]">/</span>
//           <span className="text-[#8245ec]">Tiwari</span>
//           <span className="text-[#8245ec]">&gt;</span>
//         </div>
//         {/* Desktop menu */}
...
//           <a
//             href="https://github.com/JigyasuT"
//             target="_blank"
...
//           </a>
//           <a
//             href="https://www.linkedin.com/in/jigyasu-tiwari-4b7829332/"
//             target="_blank"
//             rel="noopener noreferrer"
//             className="text-gray-300 hover:text-[#8245ec]"
//           >
  ...
  return (
    ...
    >
      <div className="text-white py-5 flex justify-between items-center">
        ...
        <div className="text-lg font-semibold cursor-pointer">
          <span className="text-[#8245ec]">&lt;</span>
          <span className="text-white">Jigyasu</span>
          <span className="text-[#8245ec]">/</span>
